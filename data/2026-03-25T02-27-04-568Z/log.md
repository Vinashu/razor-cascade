PS C:\Repos\razor-cascade> bun run study --configs baseline-openai,openai-mini,openai-nano,baseline-grok,grok,baseline-gemini,gemini --runs 10 --judge --judge-provider anthropic --judge-model claude-haiku-4-5 --judge-repeat 2 --snapshot --verbose
